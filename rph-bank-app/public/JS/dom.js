...
export const dom = {
  ...
  sendPaymentsButton: document.querySelector("#btn-send-payments"),
  handlePaymentsButton: document.querySelector("#btn-handle-payments"),
  sendAcksButton: document.querySelector("#btn-send-acks"),
